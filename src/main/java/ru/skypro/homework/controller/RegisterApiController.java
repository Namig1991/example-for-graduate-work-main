...
public class RegisterApiController implements RegisterApi {
    ...
    public ResponseEntity<Object> registerUsingPOST(@Parameter(in = ParameterIn.DEFAULT, description = "req", required=true, schema=@Schema()) @Valid @RequestBody RegReq body) {
